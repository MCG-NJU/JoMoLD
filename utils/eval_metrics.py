...
def print_overall_metric(F_seg_a, F_seg_v, F_seg, F_seg_av, F_event_a, F_event_v, F_event, F_event_av):
    ...
    print('Audio Event Detection Segment-level F1, Visual Event Detection Segment-level F1, '
          'Audio-Visual Event Detection Segment-level F1, Segment-level Type@Avg. F1, '
          'Segment-level Event@Avg. F1, Audio Event Detection Event-level F1, '
          'Visual Event Detection Event-level F1, Audio-Visual Event Detection Event-level F1, '
          'Event-level Type@Avg. F1, Event-level Event@Avg. F1')
